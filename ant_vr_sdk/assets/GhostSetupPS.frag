...
void main()
{
	gl_FragColor = texture(g_Texture1, TexCoord1)*texture(g_Texture4, TexCoord1).g*g_colorCoeff[0]
				 + texture(g_Texture1, TexCoord2)*texture(g_Texture4, TexCoord2).g*g_colorCoeff[1]
				 + texture(g_Texture2, TexCoord3)*texture(g_Texture4, TexCoord3).g*g_colorCoeff[2]
				 + texture(g_Texture3, TexCoord4)*texture(g_Texture4, TexCoord4).g*g_colorCoeff[3];
}
